...
game.createClass('Logo', {
    init: function() {
        ...
        var logo1 = new game.Sprite('logo1.png', game.system.width / 2, 80, { anchor: { x: 0.5, y: 0.5 }});
        logo1.addTo(this.container);

        var logo2 = new game.Sprite('logo2.png', game.system.width / 2, 0, { anchor: { x: 0.5, y: 0.5 }});
        logo2.addTo(this.container);
        
        var playbutton = new game.Sprite('playbutton.png', game.system.width / 2, 0, { anchor: { x: 0.5, y: 0.5 }});
        playbutton.addTo(this.container);
        ...
        game.scene.addTween(playbutton.position, {
            y: 435
        }, 1000, {
            easing: 'Quadratic.InOut'
        }).start();
