...
game.createScene('Main', {
    ...
    init: function() {
        ...
        var text = new game.Sprite('madewithpanda.png', game.system.width / 2, game.system.height - 78, {
            anchor: { x: 0.5, y: 0 }
        }).addTo(this.stage);
    ...
    showScore: function() {
        var box = new game.Sprite('gameover.png', game.system.width / 2, game.system.height / 2.2, { anchor: { x: 0.5, y: 0.5 }});
            ...
            this.addTimer(time, function() {
                ...
                if (scoreCounter >= game.scene.score) {
                    ...
                    if (game.scene.score > highScore) {
                        ...
                        var newBox = new game.Sprite('new.png', -235, 70);
                        box.addChild(newBox);
                    }
